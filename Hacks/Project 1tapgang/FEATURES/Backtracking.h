...
static auto cl_interp = INTERFACES::cvar->FindVar("cl_interpolate");
...
player->SetupBones(boneMatrix, MAXSTUDIOBONES, BONE_USED_BY_HITBOX, INTERFACES::Globals->curtime);
