...
bool IsGrenade(SDK::CBaseWeapon* weapon)
{
	...
	if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_HEGRENADE || WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_INC ||
		...
		if ((type) && path.size() > 1)
		{
			...
			if (RENDER::WorldToScreen(prev, nadeEnd))
			{
				if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_FLASHBANG)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "");
				else if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_HEGRENADE)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "");
				else if (WeaponIDz == SDK::ItemDefinitionIndex::WEAPON_INC)
					RENDER::DrawF((int)nadeEnd.x - 5, (int)nadeEnd.y, FONTS::visuals_esp_font, true, true, CColor(255, 255, 255, 255), "");
