...
namespace ImGui
{
	...
	// create demo/test window. demonstrate most ImGui features. call this to learn about the library! try to make it always available in your application!
	...
	IMGUI_API bool          ListBoxComboMain(int* current_item, void* data, int items_count);
	IMGUI_API bool          ListBoxCombo(const char* label, const ImVec2& size_arg, int* current_item, void* data, int items_count, bool border = false, ImGuiWindowFlags extra_flags = 0);
