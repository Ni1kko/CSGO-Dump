...
//{
//	int someweaponvalue = 0;
//	if (Tab == Tab_Misc, Misc_WeaponConfigs)
//	{
//		if (Settings.GetSetting(Tab_Misc, Misc_WhichWeapon) == 0 || Settings.GetSetting(Tab_Misc, Misc_WhichWeapon) == 9)
//		{
...
//}
//void SettingsManger::SetSetting2(int Setting, double Value)
//{
//	int someweaponvalue = 0;
//	if (Settings.GetSetting(Tab_Misc, Misc_WeaponConfigs))
//	{
...
//	}
//	
//	SettingsArray2[Setting][someweaponvalue] = Value;
//}
//
...
//}
//
//double SettingsManger::GetSetting2(int Setting)
//{
//	int someweaponvalue = 0;
//
//	return SettingsArray2[Setting][someweaponvalue];
//}
//
...
//}
//
//double SettingsManger::GetMenuSetting2(int Setting)
//{
//	int someweaponvalue = 0;
//	if (Settings.GetSetting(Tab_Misc, Misc_WeaponConfigs))
//	{
...
//void savesets()
//{
//	int number = Settings.GetSetting2( Config_type );
//	if( CreateDirectory( "C:/perfecthack", nullptr ) || ERROR_ALREADY_EXISTS == GetLastError() )
//	{
//	}
//
//	std::string savename[] = { "c:/perfecthack/Default", "c:/perfecthack/Legit", "c:/perfecthack/HvH", "c:/perfecthack/Rage", "c:/perfecthack/Casual", "c:/perfecthack/Custom1", "c:/perfecthack/Custom2" };
//	std::string savetype = savename[number];
//	savetype.append( ".txt" );
//
//	string txt;
...
//
//			case 3:
//				mena = MAXVALUECHANGER;
//				break;
//
//			case 4:
//				mena = MAXVALUEANTIAIM;
//				break;
//
//			case 5:
//				mena = MAXVALUECOLORS;
