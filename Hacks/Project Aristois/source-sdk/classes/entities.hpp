...
public:
	...
	void set_angles(vec3_t angles) {
		...
		static original_fn set_angles_fn = (original_fn)((uintptr_t)utilities::pattern_scan(GetModuleHandleA("client.dll"), "55 8B EC 83 E4 F8 83 EC 64 53 56 57 8B F1"));
		set_angles_fn(this, angles);
	}
	void set_position(vec3_t position) {
		using original_fn = void(__thiscall*)(void*, const vec3_t&);
		static original_fn set_position_fn = (original_fn)((uintptr_t)utilities::pattern_scan(GetModuleHandleA("client.dll"), "55 8B EC 83 E4 F8 51 53 56 57 8B F1 E8"));
...
public:
	...
	bool has_c4() {
		static auto ret = reinterpret_cast<bool(__thiscall*)(void*)>(utilities::pattern_scan(GetModuleHandleA("client.dll"), "56 8B F1 85 F6 74 31"));
		return ret(this);
	}
	...
	vec3_t eye_pos() {
		vec3_t ret;
		utilities::call_virtual<void(__thiscall*)(void*, vec3_t&)>(this, 284)(this, ret); // this is the real eye pos
		return ret;
	}
