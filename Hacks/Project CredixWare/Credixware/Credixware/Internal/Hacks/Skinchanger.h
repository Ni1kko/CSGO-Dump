...
namespace SkinChanger {
	...
	void Init() {
		...
		WeaponSkinLists[WEAPON_GALIL].Init(24, 0, AQUA_TERRACE, BLACK_SAND, BLUE_TITANIUM, CERBERUS, CHATTERBOX, COLD_FUSION, CRIMSON_TSUNAMI, ECO, FIREFIGHT, HUNTING_BLIND, KAMI2, ORANGE_DDPAT, ROCKET_POP, SAGE_SPRAY, SANDSTORM, SHATTERED, SIGNAL, STONE_COLD, SUGAR_RUSH, TUXEDO, URBAN_RUBBLE, VARICAMO, WINTER_FOREST);
		WeaponSkinLists[WEAPON_M249].Init(0);
		WeaponSkinLists[WEAPON_M4A4].Init(28, 0, ASIIMOV, BULLET_RAIN, BUZZ_KILL, CONVERTER, DAYBREAK, DESERT_STORM, DESERT_STRIKE, DESOLATE_SPACE, EVIL_DAIMYO, FADED_ZEBRA, GRIFFIN, HELLFIRE, HOWL, JUNGLE_TIGER, MAGNESIUM, MAINFRAME, MODERN_HUNTER, NEO_NOIR2, POSEIDON, RADIATION_HAZARD, ROYAL_PALADIN, THE_BATTLESTAR, TORNADO, URBAN_DDPAT, X_RAY, ZIRKA, DRAGON_KING);
		...
		WeaponSkinLists[WEAPON_P2000].Init(23, 0, AMBER_FADE, CHAINMAIL, COACH_CLASS, CORTICERA2, FIRE_ELEMENTAL, GRANITE_MARBLEIZED, GRASSLAND, GRASSLAND_LEAVES, HANDGUN, IMPERIAL, IMPERIAL_DRAGON, IVORY, OCEAN_FOAM, OCEANIC, PATHFINDER, PULSE3, RED_FRAGCAM, SCORPION, SILVER, TURF, URBAN_HAZARD3, WOODSMAN);
		...
		WeaponSkinLists[WEAPON_SG553].Init(22, 0, AERIAL, ALOHA2, ANODIZED_NAVY, ARMY_SHEEN, ATLAS, BULLDOZER, CYREX3, DAMASCUS_STEEL, DANGER_CLOSE, FALLOUT_WARNING2, GATOR_MESH, INTEGRALE, PHANTOM, PULSE2, TIGER_MOTH, TORNADO, TRAVELER, TRIARCH, ULTRAVIOLET, WAVE_SPRAY, WAVES_PERFORATED);
		...
		WeaponSkinLists[WEAPON_M4A1S].Init(25, 0, ATOMIC_ALLOY, BASILISK, BLOOD_TIGER, BOREAL_FOREST, BRIEFING2, BRIGHT_WATER, CHANTICOS_FIRE, CONTROL_PANEL, CYREX2, DARK_WATER, DECIMATOR, FLASHBACK, GOLDEN_COIL, GUARDIAN, HOT_ROD2, HYPER_BEAST, ICARUS_FELL, KNIGHT, LEADED_GLASS, MASTER_PIECE, MECHA_INDUSTRIES, NIGHTMARE, NITRO, VARICAMO);
		WeaponSkinLists[WEAPON_USPS].Init(24, 0, BLOOD_TIGER, BLUEPRINT2, BUSINESS_CLASS, CAIMAN, CHECK_ENGINE, CORTEX, CYREX4, DARK_WATER, FLASHBACK, FOREST_LEAVES, GUARDIAN2, KILL_CONFIRMED, LEAD_CONDUIT, NEO_NOIR2, NIGHT_OPS, ORION, OVERGROWTH, PARA_GREEN, ROAD_RASH, ROYAL_BLUE, SERUM, STAINLESS, TORQUE);
		WeaponSkinLists[WEAPON_CZ75].Init(23, 0, ARMY_SHEEN, CHALICE, CRIMSON_WEB, ECO2, EMERALD2, GREEN_PLAID, HEXANE, IMPRINT, NITRO2, POISON_DART, POLE_POSITION, POLYMER, RED_ASTOR, TACTICAT, THE_FUSCHIA_IS_NOW, TIGRIS, TREAD_PLATE, TUXEDO, TWIST, VICTORIA, XIANGLIU, YELLOW_JACKET);
		...
		KnifeSkinLists[WEAPON_KNIFE_BAYONET].Init(35, 0, AUTOTRONIC, BLACK_LAMINATE2, BLUE_STEEL, BOREAL_FOREST, BRIGHT_WATER2, CASE_HARDENED, CRIMSON_WEB, DAMASCUS_STEEL2, DOPPLER, DOPPLER2, DOPPLER3, DOPPLER4, DOPPLER5, DOPPLER6, DOPPLER7, FADE, FREEHAND, FOREST_DDPAT, GAMMA_DOPPLER, GAMMA_DOPPLER2, GAMMA_DOPPLER3, GAMMA_DOPPLER4, GAMMA_DOPPLER5, LORE, NIGHT, MARBLE_FADE, RUST_COAT3, SAFARI_MESH, SLAUGHTER, SCORCHED, STAINED, TIGER_TOOTH, URBAN_MASKED, ULTRAVIOLET);
