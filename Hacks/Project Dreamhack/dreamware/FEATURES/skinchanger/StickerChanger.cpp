...
static unsigned int __fastcall hooked_uint_fn(void* thisptr, void*, int slot, EStickerAttributeType attribute, unsigned fl)
{
	...
	if (attribute == EStickerAttributeType::Index)
	{
		...
		{
		case 0:
			return SETTINGS::settings.weapons[item->GetItemDefenitionIndex()].Stikers1;
			break;
		case 1:
			return SETTINGS::settings.weapons[item->GetItemDefenitionIndex()].Stikers2;
			break;
		case 2:
			return SETTINGS::settings.weapons[item->GetItemDefenitionIndex()].Stikers3;
			break;
		case 3:
			return SETTINGS::settings.weapons[item->GetItemDefenitionIndex()].Stikers4;
			break;
		default:
			break;
		}
