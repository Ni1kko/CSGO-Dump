...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	const ImRect check_bb(window->DC.CursorPos, window->DC.CursorPos + ImVec2(label_size.y + style.FramePadding.y * 1, label_size.y + style.FramePadding.y * 1)); // We want a square shape to we use Y twice
