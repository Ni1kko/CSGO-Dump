...
#define FCVAR_CLIENTCMD_CAN_EXECUTE	(1<<30)	// IVEngineClient::ClientCmd is allowed to execute this command. 
	...
	public:
		...
		void ConsoleColorPrintf(const CColor& MsgColor, const char* szMsgFormat, Values... Parameters)
		{
			typedef void(*oConsoleColorPrintf)(void*, const CColor&, const char*, ...);
			VMT::VMTHookManager::GetFunction<oConsoleColorPrintf>(this, 25)(this, MsgColor, szMsgFormat, Parameters...);
		}
		convar * get_convar(const char* name) {
			using original_fn = convar * (__thiscall*)(ICVar*, const char*);
