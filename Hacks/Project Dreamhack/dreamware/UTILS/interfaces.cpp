...
namespace INTERFACES
{
	...
	void InitInterfaces()
	{
		...
		ViewRender = **reinterpret_cast<SDK::IViewRender***>(UTILS::FindSignature("client_panorama.dll", "FF 50 4C 8B 06 8D 4D F4") - 6);		ViewRenderBeams = *reinterpret_cast<SDK::IViewRenderBeams**>(UTILS::FindSignature("client_panorama.dll", "A1 ? ? ? ? 56 8B F1 B9 ? ? ? ? FF 50 08") + 0x1);
