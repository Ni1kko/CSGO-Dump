...
namespace OFFSETS
{
	...
	void InitOffsets()
	{
		...
		INTERFACES::cvar->ConsoleColorPrintf(CColor(255, 0, 0, 255), "[dreamhack recode] \n");
		...
		m_flDuckAmount = UTILS::netvar_hook_manager.GetOffset("DT_BasePlayer", "m_flDuckAmount");
		m_flDuckSpeed = UTILS::netvar_hook_manager.GetOffset("DT_BasePlayer", "m_flDuckSpeed");
		m_hObserverTarget = UTILS::netvar_hook_manager.GetOffset(("DT_BasePlayer"), ("m_hObserverTarget"));
