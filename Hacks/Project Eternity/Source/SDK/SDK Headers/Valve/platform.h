...
PLATFORM_INTERFACE
void Plat_DebugString( const tchar* );
#else
...
PLATFORM_INTERFACE
void GetCurrentDayOfTheWeek( int* pDay ); // 0 = Sunday
PLATFORM_INTERFACE
void GetCurrentDayOfTheYear( int* pDay ); // 0 = Jan 1
...
void ResetBaseTime( void ) // reset plat_floattime to 0 for a subprocess
{
}
