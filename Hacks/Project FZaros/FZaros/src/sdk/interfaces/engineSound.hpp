...
{
public:
	void getActiveSounds( CUtlVector<soundInfo> & sndlist ) {
		using original_fn = void( __thiscall* )( CEngineSound*, CUtlVector<soundInfo> & );
		return ( *(original_fn** )this )[ 19 ]( this, sndlist );
	}
};
