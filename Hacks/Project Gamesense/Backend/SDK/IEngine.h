...
#include "vmatrix.h"
#include "vfunc.hpp"
#include "../Features/Ragebot/Prediction/Pridiction.h"
...
class IEngine
{
	public:
		...
		virtual int                   GetLocalPlayerIndex( void ) = 0;
		...
		NetChannel* GetNetChannel()
		{
			...
			if ( this )
				return vfunc<Fn>( this, 78 )( this );
		}
		void GetViewAngles1( Vector &angle )
		{
			typedef void( __thiscall * Fn )( void*, Vector & );
			return vfunc<Fn>( this, 18 )( this, angle );
		}
};
