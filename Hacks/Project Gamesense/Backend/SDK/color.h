...
class CColor
{
	public:
		...
		static CColor FromHSB( float hue /* 0.f - 1.f*/,
		    ...
		    int alpha = 255 )
		{
			hue = Cheat::Utilities->Util_Clamp( hue, 0.f, 1.f );
			saturation = Cheat::Utilities->Util_Clamp( saturation, 0.f, 1.f );
			brightness = Cheat::Utilities->Util_Clamp( brightness, 0.f, 1.f );
