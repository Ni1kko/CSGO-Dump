...
//-----------------------------------------------------------------------------
	...
	#define DLL_EXPORT				extern xorstr_("C") __declspec( dllexport )
	#define DLL_IMPORT				extern xorstr_("C") __declspec( dllimport )

	// Can't use extern xorstr_("C") when DLL exporting a class
	#define DLL_CLASS_EXPORT		__declspec( dllexport )
	#define DLL_CLASS_IMPORT		__declspec( dllimport )

	// Can't use extern xorstr_("C") when DLL exporting a global
	...
	// Used for dll exporting and importing
	#define DLL_EXPORT				extern xorstr_("C") __attribute__ ((visibility(xorstr_("default"))))
	#define DLL_IMPORT				extern xorstr_("C")

	// Can't use extern xorstr_("C") when DLL exporting a class
	#define DLL_CLASS_EXPORT		__attribute__ ((visibility(xorstr_("default"))))
	#define DLL_CLASS_IMPORT

	// Can't use extern xorstr_("C") when DLL exporting a global
	#define DLL_GLOBAL_EXPORT		__attribute__((visibility(xorstr_("default"))))
...
//-----------------------------------------------------------------------------
	...
	#define DebuggerBreak()		DebugBreak()
		...
		#define DebuggerBreak()		__asm__( xorstr_("int $0x3;"))
	#else
		#define DebuggerBreak()		asm( xorstr_("int3") )
	#endif
#endif
...
{
	return IsPlatformX360() ? xorstr_(".360") : xorstr_("");
}
...
// xorstr_("outer") class, this is a much more space efficient way to Get at the outer
...
//			{
//				printf( xorstr_("Outer is at 0x%x\n"), GET_OUTER( COuter, m_Inner ) );
//			}
//		};
//
//		CInner m_Inner;
