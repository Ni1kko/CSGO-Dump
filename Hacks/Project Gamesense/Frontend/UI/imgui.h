...
namespace ui
{
    ...
    IMGUI_API bool          BeginWeapon(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0);
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, bool border = false);
    IMGUI_API void          End();
    ...
    IMGUI_API bool          BeginChildWeapon(const char* str_id, const ImVec2& size = ImVec2(0, 0), bool border = false, ImGuiWindowFlags flags = 0);
    ...
    IMGUI_API bool          CheckboxYellow(const char* label, bool* v);
