...
// ay::obfuscated_data object with global etime that has functions for
...
// reference to a ay::obfuscated_data object with global etime that has
...
#define xor_str(text) std::string( AY_OBFUSCATE(text) ).c_str()
/* -------------------------------- LICENSE ------------------------------------
