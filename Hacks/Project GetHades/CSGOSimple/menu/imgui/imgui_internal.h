...
namespace ImGui
{
	...
	IMGUI_API bool			ButtonExT( const char * label, const ImVec2 & size_arg = ImVec2( 0, 0 ), ImGuiButtonFlags flags = 0, int page = 0, int in = 0, bool border = true, ImColor clr = ImColor(255,255,255,255) );
