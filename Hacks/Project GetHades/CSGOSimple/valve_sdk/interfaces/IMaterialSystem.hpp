...
#define TEXTURE_GROUP_LIGHTMAP						        xor_str ("Lightmaps")
#define TEXTURE_GROUP_WORLD							          xor_str ("World textures")
#define TEXTURE_GROUP_MODEL							          xor_str ("Model textures")
#define TEXTURE_GROUP_VGUI							          xor_str ("VGUI textures")
#define TEXTURE_GROUP_PARTICLE						        xor_str ("Particle textures")
#define TEXTURE_GROUP_DECAL							          xor_str ("Decal textures")
#define TEXTURE_GROUP_SKYBOX						          "SkyBox textures")
#define TEXTURE_GROUP_CLIENT_EFFECTS				      xor_str ("ClientEffect textures")
#define TEXTURE_GROUP_OTHER							          xor_str ("Other textures")
#define TEXTURE_GROUP_PRECACHED						        xor_str ("Precached")
#define TEXTURE_GROUP_CUBE_MAP						        xor_str ("CubeMap textures")
#define TEXTURE_GROUP_RENDER_TARGET					      xor_str ("RenderTargets")
#define TEXTURE_GROUP_UNACCOUNTED					        xor_str ("Unaccounted textures")
//#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER		  "Static Vertex"
#define TEXTURE_GROUP_STATIC_INDEX_BUFFER			    xor_str ("Static Indices")
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_DISP		xor_str ("Displacement Verts")
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_COLOR	xor_str ("Lighting Verts")
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_WORLD	xor_str ("World Verts")
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_MODELS	xor_str ("Model Verts")
#define TEXTURE_GROUP_STATIC_VERTEX_BUFFER_OTHER	xor_str ("Other Verts")
#define TEXTURE_GROUP_DYNAMIC_INDEX_BUFFER			  xor_str ("Dynamic Indices")
#define TEXTURE_GROUP_DYNAMIC_VERTEX_BUFFER			  xor_str ("Dynamic Verts")
#define TEXTURE_GROUP_DEPTH_BUFFER					      xor_str ("DepthBuffer")
#define TEXTURE_GROUP_VIEW_MODEL					        xor_str ("ViewModel")
#define TEXTURE_GROUP_PIXEL_SHADERS					      xor_str ("Pixel Shaders")
#define TEXTURE_GROUP_VERTEX_SHADERS				      xor_str ("Vertex Shaders")
#define TEXTURE_GROUP_RENDER_TARGET_SURFACE			  xor_str ("RenderTarget Surfaces")
#define TEXTURE_GROUP_MORPH_TARGETS					      xor_str ("Morph Targets")
...
{
public:
    virtual CreateInterfaceFn init ( char const* pShaderAPIDLL, IMaterialProxyFactory* pMaterialProxyFactory, CreateInterfaceFn fileSystemFactory,
    ...
    virtual void get_mode_info ( int adapter, int mode, MaterialVideoMode_t& info ) const = 0;
    ...
    virtual IMaterial* create_material ( const char* pMaterialName, KeyValues* pVMTKeyValues ) = 0;
    virtual IMaterial* find_material ( char const* pMaterialName, const char* pTextureGroupName, bool complain = true,
    ...
    virtual IMaterial* get_material ( MaterialHandle_t h ) const = 0;
    virtual int get_num_materials ( ) const = 0;
    virtual ITexture* find_texture ( char const* pTextureName, const char* pTextureGroupName, bool complain = true ) = 0;
    ...
    virtual ITexture* CreateRenderTargetTexture ( int w, int h, RenderTargetSizeMode_t sizeMode, ImageFormat format,
    ...
    virtual ITexture* CreateNamedRenderTargetTexture ( const char* pRTName, int w, int h, RenderTargetSizeMode_t sizeMode, ImageFormat format,
                                                       MaterialRenderTargetDepth_t depth = MATERIAL_RT_DEPTH_SHARED, bool bClampTexCoords = true,
