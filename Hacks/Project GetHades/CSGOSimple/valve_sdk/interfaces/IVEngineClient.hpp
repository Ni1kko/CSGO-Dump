...
typedef struct player_info_s
{
    ...
    char sz_name[128]; //0x0010 - Player Name
...
{
public:
    virtual int GetIntersectingSurfaces ( const model_t* model, const Vector& vCenter, const float radius, const bool bOnlyVisibleSurfaces, SurfInfo* pInfos,
    ...
    virtual int get_localplayer ( void ) = 0;
    virtual const model_t* LoadModel ( const char* pName, bool bProp = false ) = 0;
    virtual float GetLastTimeStamp ( void ) = 0;
    virtual CSentence* GetSentence ( CAudioSource* pAudioSource ) = 0; // 15
    virtual float GetSentenceLength ( CAudioSource* pAudioSource ) = 0;
    virtual bool is_streaming ( CAudioSource* pAudioSource ) const = 0;
    virtual void get_viewangles ( QAngle* va ) = 0;
    virtual void set_viewangles ( QAngle* va ) = 0;
    ...
    virtual void set_achievement_mgr ( IAchievementMgr* pAchievementMgr ) = 0;
    virtual IAchievementMgr* get_achievement_mgr ( ) = 0;
    ...
    virtual void SolidMoved ( class IClientEntity* pSolidEnt, class ICollideable* pSolidCollide, const Vector* pPrevAbsOrigin,
