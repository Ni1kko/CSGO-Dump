...
enum
{
    ...
    TE_BEAMDISK = 0x02,
    // disk that expands to max radius over etime
    TE_BEAMCYLINDER = 0x03,
    // cylinder that expands to max radius over etime
    TE_BEAMFOLLOW = 0x04,
...
public:
    ...
    virtual void CreateBeamEnts ( int startEnt, int endEnt, int modelIndex, int haloIndex, float haloScale,
                                  float e, float width, float m_nEndWidth, float m_nFadeLength, float amplitude,
    ...
    virtual void CreateBeamCirclePoints ( int type, Vector& start, Vector& end,
                                          int modelIndex, int haloIndex, float haloScale, float e, float width,
    ...
    virtual void CreateBeamFollow ( int startEnt, int modelIndex, int haloIndex, float haloScale,
                                    float e, float width, float m_nEndWidth, float m_nFadeLength, float r, float g, float b,
                                    float brightness ) = 0;
};
