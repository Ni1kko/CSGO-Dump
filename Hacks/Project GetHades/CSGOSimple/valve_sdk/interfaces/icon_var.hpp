...
#define FCVAR_ARCHIVE_XBOX              (1<<24) // cvar written to c_config.cfg on the Xbox
...
//-----------------------------------------------------------------------------
typedef void (*FnChangeCallback_t) ( icon_var* var, const char* pOldValue, float flOldValue );
