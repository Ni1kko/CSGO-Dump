...
Vector4D Vector4D::ProjectOnto ( const Vector4D& onto ) const
{
...
bool Vector4D::WithinAABox ( Vector4D const& boxmin, Vector4D const& boxmax ) const
{
    return (
