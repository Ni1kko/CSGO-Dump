...
{
public:
    int register_glow_object ( IClientEntity* pEntity, const Vector& vGlowColor, float flGlowAlpha, bool bRenderWhenOccluded, bool bRenderWhenUnoccluded,
    ...
    void set_entity ( int nGlowObjectHandle, IClientEntity* pEntity )
    {
    ...
    bool is_rendering_when_occluded ( int nGlowObjectHandle ) const
    {
    ...
    bool has_glow_effect ( IClientEntity* pEntity ) const
    {
