...
namespace ImGui
{
	...
	IMGUI_API void          OpenPopupExNew(ImGuiID id, bool reopen_existing);
	...
	IMGUI_API bool          IsClippedExxd(const ImRect& bb, ImGuiID id, bool clip_even_when_logged);
	...
	IMGUI_API bool          ItemAddxd(const ImRect& bb, ImGuiID id);
