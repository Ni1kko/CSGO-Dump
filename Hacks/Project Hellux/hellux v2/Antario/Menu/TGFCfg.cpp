...
///////////////////////////////////////////////////////////////////////////////////////
	...
	SetupValue(c_config::get().extra_lua_option1, false, "Lua", "luaoption1");
	SetupValue(c_config::get().extra_lua_option2, false, "Lua", "luaoption2");
	SetupValue(c_config::get().extra_lua_option3, false, "Lua", "luaoption3");
	SetupValue(c_config::get().resolver_lua, false, "Lua", "resolver_lua");
	SetupValue(c_config::get().lua_aa, 0, "Lua", "lua_aa");
	SetupValue(c_config::get().luafiles_extra, false, "Lua", "luafiles");
