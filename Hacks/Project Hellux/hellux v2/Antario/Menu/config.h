...
public:
	...
	*/
	...
	int luafiles;
	float luafiles_extra;
	bool extra_lua_option1;
	bool extra_lua_option2;
	bool extra_lua_option3;
	bool resolver_lua;
	float lua_aa;

	int menu_color_r = 7, menu_color_g = 145, menu_color_b = 250, menu_color_a = 255;
};