...
struct BeamInfo_t
{
	//Beam
	int				m_nType;
	C_BaseEntityList*	m_pStartEnt;
	int				m_nStartAttachment;
	C_BaseEntityList*	m_pEndEnt;
...
public:
	...
	virtual void	DrawBeam(C_Beam* pbeam, int *pEntityBeamTraceFilter = NULL) = 0;
	virtual void	DrawBeam(Beam_t *pbeam) = 0;

	virtual void	KillDeadBeams(C_BaseEntityList *pEnt) = 0;
