...
//			std::cout << (enc_str("Successfully found interface - ") + InterfaceName) << std::endl;
    ...
    void Init()
    {
        g_pClientDll    = reinterpret_cast<IBaseClientDLL*>(FindInterface("client_panorama.dll", "VClient"));
        ...
        g_pEntityList   = reinterpret_cast<IClientEntityList*>(FindInterface("client_panorama.dll", "VClientEntityList"));
        g_pEngine       = reinterpret_cast<IVEngineClient*>(FindInterface("engine.dll", "VEngineClient"));
        g_pPrediction   = reinterpret_cast<CPrediction*>(FindInterface("client_panorama.dll", "VClientPrediction"));
        g_pMovement     = reinterpret_cast<IGameMovement*>(FindInterface("client_panorama.dll", "GameMovement"));
