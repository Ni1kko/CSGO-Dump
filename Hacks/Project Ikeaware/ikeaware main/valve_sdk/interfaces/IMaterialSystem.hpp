...
public:
	...
	virtual bool                            SetMode(PVOID hwnd, const MaterialSystem_Config_t& config) = 0;
	...
	virtual bool                            AddView(PVOID hwnd) = 0;
	virtual void                            RemoveView(PVOID hwnd) = 0; //40
	virtual void                            SetView(PVOID hwnd) = 0;
