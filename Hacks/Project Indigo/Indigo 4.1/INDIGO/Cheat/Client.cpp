...
namespace Client
{
	...
	void DrawSkins() // Skins
	{
		...
		{
			ImGui::Columns(2, nullptr, false);
			ImGui::Checkbox("Enable Medal Hack", &Settings::MedalChanger::enabled);
			...
			ImGui::NextColumn();
			ImGui::Checkbox("Enable Profile Hack", &Settings::ProfileChanger::enabled);
...
//		}
	...
	void DrawColors()
	{
		...
		ImGui::ColorEdit3("Dynamic Lights", Settings::Esp::esp_Dlight);
/*		ImGui::Text("Radar");
		ImGui::Separator();
