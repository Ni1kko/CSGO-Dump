...
public:
	...
	Color inverted()
	{
		return Color( 255 - _color[ 0 ], 255 - _color[ 1 ], 255 - _color[ 2 ] );
	}
...
struct VertexCol_t
{
	...
	VertexCol_t() {}
	VertexCol_t( const Vector2D &pos, const Color &col = Color( 255, 255, 255 ) )
	{

		m_Vertex = Vertex_t( pos );
		m_Col = col;
	}
	VertexCol_t( const Vector2D &pos )
	{
		m_Vertex = Vertex_t( pos );
		m_Col = Color( 255, 255, 255 );
	}
	void Init( const Vector2D &pos, const Color &col = Color( 255, 255, 255 ) )
	{
		m_Vertex = Vertex_t( pos );
		m_Col = col;
	}
