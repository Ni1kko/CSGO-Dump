...
==================
*/
void MD5Init( iMD5Context_t *ctx )
{
...
===================
*/
void MD5Update( iMD5Context_t *ctx, unsigned char const *buf, unsigned int len )
{
	unsigned int t;
...
===============
*/
void MD5Final( unsigned char digest[ 16 ], iMD5Context_t *ctx )
{
	unsigned count;
	unsigned char *p;
