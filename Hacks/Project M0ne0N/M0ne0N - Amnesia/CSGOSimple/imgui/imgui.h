...
namespace ImGui
{
	...
	IMGUI_API void          StyleColorsIndigo(ImGuiStyle* dst = NULL);    // indigo style, why nut? xd
	IMGUI_API void          StyleColorsAmnesia(ImGuiStyle* dst = NULL);    // m0ne0n styles xddddd
