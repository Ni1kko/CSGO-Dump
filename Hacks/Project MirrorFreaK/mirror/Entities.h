...
public:
	...
	float GetInaccuracy() {
		return call_vfunc<float(__thiscall*)(void*)>(this, 471)(this);
	}
		...
		if (this) {
			...
			return
				(iWeaponID == WEAPON_KNIFE || iWeaponID == WEAPON_C4
					...
					|| iWeaponID == WEAPON_KNIFE_T || iWeaponID == WEAPON_BAYONET
	...
	CSWeaponInfo* GetCSWpnData() {
		return call_vfunc<CSWeaponInfo*(__thiscall*)(void*)>(this, 448)(this);
	}
};
