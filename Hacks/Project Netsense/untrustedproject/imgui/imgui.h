...
namespace ImGui
{
    ...
    IMGUI_API void          Render(ImDrawList* out_list);               // ends the ImGui frame, finalize the draw data. (Obsolete: optionally call io.RenderDrawListsFn if set. Nowadays, prefer calling your render function yourself.)
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_Notification           = 1 << 29,  // If it's a notification window
    ImGuiWindowFlags_DoNotFillBG            = 1 << 30 
