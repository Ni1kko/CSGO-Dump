...
namespace ImGui
{
    ...
    // Inputs
    inline bool             IsKeyPressedMap2(ImGuiKey key, bool repeat = true) { const int key_index = GImGui->IO.KeyMap[key]; return (key_index >= 0) ? IsKeyPressed(key_index, repeat) : false; }
    ...
    IMGUI_API bool          SubTabEx(const char* label, bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
