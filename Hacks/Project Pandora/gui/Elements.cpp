...
namespace Menu {
	void DrawMenu( ) {
		...
		if( !once ) {
			g_cfg[ XOR( "menu_color" ) ].set_color( Color(118, 94, 255) );
			g_cfg[ XOR( "rage_aa_rotation_range" ) ].set<int>( 1 );

			once = true;
		}

		if (GUI::Form::BeginWindow(XOR("Pandora.club"))) 
		{
			if (GUI::Form::BeginTab(XOR("A"), XOR("Ragebot")))
			{
				GUI::Group::BeginGroup(XOR("General"), vec2_t(50, 100));
				{
					GUI::Controls::Checkbox(XOR("Enable aimbot"), XOR("rage_aimbot_enabled"));

					GUI::Controls::Checkbox(XOR("Limit fov"), XOR("rage_aimbot_limit_fov"));
					...
					GUI::Controls::Checkbox(XOR("Knifebot"), XOR("misc_knifebot"));

					GUI::Controls::Dropdown("Weapon", { "Auto", "Scout", "AWP", "Heavy Pistols", "Pistols" }, "rage_aimbot_weapon_group");

					std::vector<MultiItem_t> auto_hitboxes = {
						{ XOR("Head"), XOR("rage_aimbot_auto_hitbox_head") },
						{ XOR("Neck"), XOR("rage_aimbot_auto_hitbox_neck") },
						{ XOR("Chest"), XOR("rage_aimbot_auto_hitbox_chest") },
						{ XOR("Arms"), XOR("rage_aimbot_auto_hitbox_arms") },
						{ XOR("Stomach"), XOR("rage_aimbot_auto_hitbox_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_auto_hitbox_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_auto_hitbox_feet") },
					};

					std::vector<MultiItem_t> scout_hitboxes = {
						{ XOR("Head"), XOR("rage_aimbot_scout_hitbox_head") },
						{ XOR("Neck"), XOR("rage_aimbot_scout_hitbox_neck") },
						{ XOR("Chest"), XOR("rage_aimbot_scout_hitbox_chest") },
						{ XOR("Arms"), XOR("rage_aimbot_scout_hitbox_arms") },
						{ XOR("Stomach"), XOR("rage_aimbot_scout_hitbox_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_scout_hitbox_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_scout_hitbox_feet") },
					};

					std::vector<MultiItem_t> awp_hitboxes = {
						{ XOR("Head"), XOR("rage_aimbot_awp_hitbox_head") },
						{ XOR("Neck"), XOR("rage_aimbot_awp_hitbox_neck") },
						{ XOR("Chest"), XOR("rage_aimbot_awp_hitbox_chest") },
						{ XOR("Arms"), XOR("rage_aimbot_awp_hitbox_arms") },
						{ XOR("Stomach"), XOR("rage_aimbot_awp_hitbox_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_awp_hitbox_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_awp_hitbox_feet") },
					};

					std::vector<MultiItem_t> heavy_pistols_hitboxes = {
						{ XOR("Head"), XOR("rage_aimbot_heavy_pistols_hitbox_head") },
						{ XOR("Neck"), XOR("rage_aimbot_heavy_pistols_hitbox_neck") },
						{ XOR("Chest"), XOR("rage_aimbot_heavy_pistols_hitbox_chest") },
						{ XOR("Arms"), XOR("rage_aimbot_heavy_pistols_hitbox_arms") },
						{ XOR("Stomach"), XOR("rage_aimbot_heavy_pistols_hitbox_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_heavy_pistols_hitbox_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_heavy_pistols_hitbox_feet") },
					};

					std::vector<MultiItem_t> pistols_hitboxes = {
						{ XOR("Head"), XOR("rage_aimbot_pistols_hitbox_head") },
						{ XOR("Neck"), XOR("rage_aimbot_pistols_hitbox_neck") },
						{ XOR("Chest"), XOR("rage_aimbot_pistols_hitbox_chest") },
						{ XOR("Arms"), XOR("rage_aimbot_pistols_hitbox_arms") },
						{ XOR("Stomach"), XOR("rage_aimbot_pistols_hitbox_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_pistols_hitbox_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_pistols_hitbox_feet") },
					};

					std::vector<MultiItem_t> other_hitboxes = {
						{ XOR("Head"), XOR("rage_aimbot_other_hitbox_head") },
						{ XOR("Neck"), XOR("rage_aimbot_other_hitbox_neck") },
						{ XOR("Chest"), XOR("rage_aimbot_other_hitbox_chest") },
						{ XOR("Arms"), XOR("rage_aimbot_other_hitbox_arms") },
						{ XOR("Stomach"), XOR("rage_aimbot_other_hitbox_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_other_hitbox_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_other_hitbox_feet") },
					};



					std::vector<MultiItem_t> auto_multipoint = {
						{ XOR("Head"), XOR("rage_aimbot_auto_multipoint_head") },
						{ XOR("Chest"), XOR("rage_aimbot_auto_multipoint_chest") },
						{ XOR("Stomach"), XOR("rage_aimbot_auto_multipoint_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_auto_multipoint_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_auto_multipoint_feet") },
					};

					std::vector<MultiItem_t> scout_multipoint = {
						{ XOR("Head"), XOR("rage_aimbot_scout_multipoint_head") },
						{ XOR("Chest"), XOR("rage_aimbot_scout_multipoint_chest") },
						{ XOR("Stomach"), XOR("rage_aimbot_scout_multipoint_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_scout_multipoint_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_scout_multipoint_feet") },
					};

					std::vector<MultiItem_t> awp_multipoint = {
						{ XOR("Head"), XOR("rage_aimbot_awp_multipoint_head") },
						{ XOR("Chest"), XOR("rage_aimbot_awp_multipoint_chest") },
						{ XOR("Stomach"), XOR("rage_aimbot_awp_multipoint_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_awp_multipoint_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_awp_multipoint_feet") },
					};

					std::vector<MultiItem_t> heavy_pistols_multipoint = {
						{ XOR("Head"), XOR("rage_aimbot_heavy_pistols_multipoint_head") },
						{ XOR("Chest"), XOR("rage_aimbot_heavy_pistols_multipoint_chest") },
						{ XOR("Stomach"), XOR("rage_aimbot_heavy_pistols_multipoint_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_heavy_pistols_multipoint_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_heavy_pistols_multipoint_feet") },
					};

					std::vector<MultiItem_t> pistols_multipoint = {
						{ XOR("Head"), XOR("rage_aimbot_pistols_multipoint_head") },
						{ XOR("Chest"), XOR("rage_aimbot_pistols_multipoint_chest") },
						{ XOR("Stomach"), XOR("rage_aimbot_pistols_multipoint_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_pistols_multipoint_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_pistols_multipoint_feet") },
					};

					std::vector<MultiItem_t> other_multipoint = {
						{ XOR("Head"), XOR("rage_aimbot_other_multipoint_head") },
						{ XOR("Chest"), XOR("rage_aimbot_other_multipoint_chest") },
						{ XOR("Stomach"), XOR("rage_aimbot_other_multipoint_stomach") },
						{ XOR("Legs"), XOR("rage_aimbot_other_multipoint_legs") },
						{ XOR("Feet"), XOR("rage_aimbot_other_multipoint_feet") },
					};

					switch (g_cfg["rage_aimbot_weapon_group"].get<int>())
					{
					case 0: // auto
					{
						GUI::Controls::MultiDropdown(XOR("Hitboxes"), auto_hitboxes);
						GUI::Controls::MultiDropdown(XOR("Multipoints"), auto_multipoint);

						GUI::Controls::Slider(XOR("Multipoints scale"), XOR("rage_aimbot_auto_multipoint_scale"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Hitchance"), XOR("rage_aimbot_auto_hitchance"));
						if (g_cfg[XOR("rage_aimbot_auto_hitchance")].get<bool>())
							GUI::Controls::Slider(XOR("Minimal hitchance"), XOR("rage_aimbot_auto_hitchance_amount"), 1.f, 100.f, XOR("%.0f"));

						GUI::Controls::Slider(XOR("Minimal damage"), XOR("rage_aimbot_auto_minimal_damage"), 1.f, 100.f, XOR("%.0f"));
						GUI::Controls::Slider(XOR("Minimal penetration damage"), XOR("rage_aimbot_auto_penetration_minimal_damage"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Minimal damage override"), XOR("rage_aimbot_auto_minimal_damage_override_pen"));

						if (g_cfg[XOR("rage_aimbot_minimal_damage_override_pen")].get<bool>() || g_cfg[XOR("rage_aimbot_auto_minimal_damage_override_pen")].get<bool>())
						{
							GUI::Controls::Label(XOR("Minimal damage override"));
							GUI::Controls::Hotkey(XOR("Minimal damage override key"), XOR("rage_aimbot_auto_minimal_damage_override_key"));
							GUI::Controls::Slider(XOR("Damage override amount"), XOR("rage_aimbot_auto_minimal_damage_override"), 1.f, 100.f, XOR("%.0f"));
						}
					} break;
					case 1: // scout
					{
						GUI::Controls::MultiDropdown(XOR("Hitboxes"), scout_hitboxes);
						GUI::Controls::MultiDropdown(XOR("Multipoints"), scout_multipoint);

						GUI::Controls::Slider(XOR("Multipoints scale"), XOR("rage_aimbot_scout_multipoint_scale"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Hitchance"), XOR("rage_aimbot_scout_hitchance"));
						if (g_cfg[XOR("rage_aimbot_scout_hitchance")].get<bool>())
							GUI::Controls::Slider(XOR("Minimal hitchance"), XOR("rage_aimbot_scout_hitchance_amount"), 1.f, 100.f, XOR("%.0f"));

						GUI::Controls::Slider(XOR("Minimal damage"), XOR("rage_aimbot_scout_minimal_damage"), 1.f, 100.f, XOR("%.0f"));
						GUI::Controls::Slider(XOR("Minimal penetration damage"), XOR("rage_aimbot_scout_penetration_minimal_damage"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Minimal damage override"), XOR("rage_aimbot_scout_minimal_damage_override_pen"));

						if (g_cfg[XOR("rage_aimbot_minimal_damage_override_pen")].get<bool>() || g_cfg[XOR("rage_aimbot_scout_minimal_damage_override_pen")].get<bool>())
						{
							GUI::Controls::Label(XOR("Minimal damage override"));
							GUI::Controls::Hotkey(XOR("Minimal damage override key"), XOR("rage_aimbot_scout_minimal_damage_override_key"));
							GUI::Controls::Slider(XOR("Damage override amount"), XOR("rage_aimbot_scout_minimal_damage_override"), 1.f, 100.f, XOR("%.0f"));
						}
					} break;
					case 2: // awp
					{
						GUI::Controls::MultiDropdown(XOR("Hitboxes"), awp_hitboxes);
						GUI::Controls::MultiDropdown(XOR("Multipoints"), awp_multipoint);

						GUI::Controls::Slider(XOR("Multipoints scale"), XOR("rage_aimbot_awp_multipoint_scale"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Hitchance"), XOR("rage_aimbot_awp_hitchance"));
						if (g_cfg[XOR("rage_aimbot_awp_hitchance")].get<bool>())
							GUI::Controls::Slider(XOR("Minimal hitchance"), XOR("rage_aimbot_awp_hitchance_amount"), 1.f, 100.f, XOR("%.0f"));

						GUI::Controls::Slider(XOR("Minimal damage"), XOR("rage_aimbot_awp_minimal_damage"), 1.f, 100.f, XOR("%.0f"));
						GUI::Controls::Slider(XOR("Minimal penetration damage"), XOR("rage_aimbot_awp_penetration_minimal_damage"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Minimal damage override"), XOR("rage_aimbot_awp_minimal_damage_override_pen"));

						if (g_cfg[XOR("rage_aimbot_minimal_damage_override_pen")].get<bool>() || g_cfg[XOR("rage_aimbot_awp_minimal_damage_override_pen")].get<bool>())
						{
							GUI::Controls::Label(XOR("Minimal damage override"));
							GUI::Controls::Hotkey(XOR("Minimal damage override key"), XOR("rage_aimbot_awp_minimal_damage_override_key"));
							GUI::Controls::Slider(XOR("Damage override amount"), XOR("rage_aimbot_awp_minimal_damage_override"), 1.f, 100.f, XOR("%.0f"));
						}
					} break;
					case 3: // heavy pistols
					{
						GUI::Controls::MultiDropdown(XOR("Hitboxes"), heavy_pistols_hitboxes);
						GUI::Controls::MultiDropdown(XOR("Multipoints"), heavy_pistols_multipoint);

						GUI::Controls::Slider(XOR("Multipoints scale"), XOR("rage_aimbot_heavy_pistols_multipoint_scale"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Hitchance"), XOR("rage_aimbot_heavy_pistols_hitchance"));
						if (g_cfg[XOR("rage_aimbot_heavy_pistols_hitchance")].get<bool>())
							GUI::Controls::Slider(XOR("Minimal hitchance"), XOR("rage_aimbot_heavy_pistols_hitchance_amount"), 1.f, 100.f, XOR("%.0f"));

						GUI::Controls::Slider(XOR("Minimal damage"), XOR("rage_aimbot_heavy_pistols_minimal_damage"), 1.f, 100.f, XOR("%.0f"));
						GUI::Controls::Slider(XOR("Minimal penetration damage"), XOR("rage_aimbot_heavy_pistols_penetration_minimal_damage"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Label(XOR("Minimal damage override"));
						GUI::Controls::Hotkey(XOR("Minimal damage override key"), XOR("rage_aimbot_heavy_pistols_minimal_damage_override_key"));

						GUI::Controls::Slider(XOR("Damage override amount"), XOR("rage_aimbot_heavy_pistols_minimal_damage_override"), 1.f, 100.f, XOR("%.0f"));
						GUI::Controls::Checkbox(XOR("Override penetration damage"), XOR("rage_aimbot_heavy_pistols_minimal_damage_override_pen"));
					} break;
					case 4: // pistols
					{
						GUI::Controls::MultiDropdown(XOR("Hitboxes"), pistols_hitboxes);
						GUI::Controls::MultiDropdown(XOR("Multipoints"), pistols_multipoint);

						GUI::Controls::Slider(XOR("Multipoints scale"), XOR("rage_aimbot_pistols_multipoint_scale"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Hitchance"), XOR("rage_aimbot_pistols_hitchance"));
						if (g_cfg[XOR("rage_aimbot_pistols_hitchance")].get<bool>())
							GUI::Controls::Slider(XOR("Minimal hitchance"), XOR("rage_aimbot_pistols_hitchance_amount"), 1.f, 100.f, XOR("%.0f"));

						GUI::Controls::Slider(XOR("Minimal damage"), XOR("rage_aimbot_pistols_minimal_damage"), 1.f, 100.f, XOR("%.0f"));
						GUI::Controls::Slider(XOR("Minimal penetration damage"), XOR("rage_aimbot_pistols_penetration_minimal_damage"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Minimal damage override"), XOR("rage_aimbot_pistols_minimal_damage_override_pen"));

						if (g_cfg[XOR("rage_aimbot_minimal_damage_override_pen")].get<bool>() || g_cfg[XOR("rage_aimbot_pistols_minimal_damage_override_pen")].get<bool>())
						{
							GUI::Controls::Label(XOR("Minimal damage override"));
							GUI::Controls::Hotkey(XOR("Minimal damage override key"), XOR("rage_aimbot_pistols_minimal_damage_override_key"));
							GUI::Controls::Slider(XOR("Damage override amount"), XOR("rage_aimbot_pistols_minimal_damage_override"), 1.f, 100.f, XOR("%.0f"));
						}
					} break;
					case 5: // other
					{
						GUI::Controls::MultiDropdown(XOR("Hitboxes"), other_hitboxes);
						GUI::Controls::MultiDropdown(XOR("Multipoints"), other_multipoint);

						GUI::Controls::Slider(XOR("Multipoints scale"), XOR("rage_aimbot_other_multipoint_scale"), 0.f, 100.f, XOR("%.0f"));
						GUI::Controls::Slider(XOR("Stomach scale"), XOR("rage_aimbot_other_stomach_scale"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Hitchance"), XOR("rage_aimbot_other_hitchance"));
						if (g_cfg[XOR("rage_aimbot_other_hitchance")].get<bool>())
							GUI::Controls::Slider(XOR("Minimal hitchance"), XOR("rage_aimbot_other_hitchance_amount"), 1.f, 100.f, XOR("%.0f"));

						GUI::Controls::Slider(XOR("Minimal damage"), XOR("rage_aimbot_other_minimal_damage"), 1.f, 100.f, XOR("%.0f"));
						GUI::Controls::Slider(XOR("Minimal penetration damage"), XOR("rage_aimbot_other_penetration_minimal_damage"), 0.f, 100.f, XOR("%.0f"));

						GUI::Controls::Checkbox(XOR("Scale damage on hp"), XOR("rage_aimbot_other_minimal_damage_hp"));
						GUI::Controls::Checkbox(XOR("Scale penetration damage on hp"), XOR("rage_aimbot_other_penetration_minimal_damage_hp"));

						GUI::Controls::Checkbox(XOR("Minimal damage override"), XOR("rage_aimbot_other_minimal_damage_override_pen"));

						if (g_cfg[XOR("rage_aimbot_minimal_damage_override_pen")].get<bool>() || g_cfg[XOR("rage_aimbot_other_minimal_damage_override_pen")].get<bool>())
						{
							GUI::Controls::Label(XOR("Minimal damage override"));
							GUI::Controls::Hotkey(XOR("Minimal damage override key"), XOR("rage_aimbot_other_minimal_damage_override_key"));
							GUI::Controls::Slider(XOR("Damage override amount"), XOR("rage_aimbot_other_minimal_damage_override"), 1.f, 100.f, XOR("%.0f"));
						}
					} break;
					}
				...
				GUI::Group::BeginGroup(XOR("Accuracy"), vec2_t(50, 70));
				{
					...
					GUI::Controls::Checkbox(XOR("Ignore limbs when moving"), XOR("rage_aimbot_auto_ignore_limbs"));
					...
					GUI::Controls::Checkbox(XOR("Prefer safepoint"), XOR("rage_aimbot_other_prefer_safepoint"));
					GUI::Controls::Label(XOR("Force safepoint"));
					GUI::Controls::Hotkey(XOR("Safepoint"), XOR("rage_other_safepoint_key"));
				}GUI::Group::EndGroup();

				GUI::Group::BeginGroup(XOR("Exploits"), vec2_t(50, 30));
				{
					...
					if (g_cfg[XOR("rage_exploit_type")].get<int>() > 0)
					{
						...
						GUI::Controls::Checkbox(XOR("Ignore hitchance at use"), XOR("rage_exploit_ignore_hitchance"));
			...
			if (GUI::Form::BeginTab(XOR("H"), XOR("Anti-aim")))
			{
				GUI::Group::BeginGroup(XOR("Real anti-aim"), vec2_t(50, 100));
				{
					GUI::Controls::Checkbox(XOR("Enable##anti-aim"), XOR("rage_aa_enabled"));

					GUI::Controls::Dropdown(XOR("Pitch"), { XOR("None"), XOR("Down"), XOR("Up"), XOR("Zero"), XOR("Random"), XOR("Jitter"), XOR("Fake down"), XOR("Fake up"), XOR("Fake jitter") }, XOR("rage_aa_pitch"));
					...
					{
						if (yaw == 1)
							GUI::Controls::Dropdown(XOR("Direction"), { XOR("Backwards") }, XOR("rage_aa_yaw_direction"));
				...
				GUI::Group::BeginGroup(XOR("Fake anti-aim"), vec2_t(50, 53));
				{
					...
					GUI::Controls::Slider(XOR("Desync amount"), XOR("rage_aa_custom_fake"), -60.f, 60.f, XOR("%.0f%%"));

					GUI::Controls::Label(XOR("Invert desync"));
					GUI::Controls::Hotkey(XOR("Invert desync"), XOR("rage_aa_negate_key"));


				}GUI::Group::EndGroup();

				GUI::Group::BeginGroup(XOR("Fake-lag"), vec2_t(50, 53));
				{
			...
			{
				GUI::Group::BeginGroup(XOR("Other ESP"), vec2_t(50, 100)); 
				{
					...
					GUI::Controls::Checkbox(XOR("Enemy Grenade Prediction"), XOR("visuals_misc_grenade_prediction_trail"));
					GUI::Controls::ColorPicker(XOR("Grenade Trail Color"), XOR("visuals_misc_grenade_prediction_trailcolor"));

					GUI::Controls::Checkbox(XOR("Enemy Grenade Prediction Circle"), XOR("visuals_misc_grenade_prediction_radius"));
					GUI::Controls::ColorPicker(XOR("Grenade Prediction Color"), XOR("visuals_misc_grenade_prediction_radiuscolor"));

					GUI::Controls::MultiDropdown(XOR("Bomb ESP"), Bomb);

				}GUI::Group::EndGroup();

				GUI::Group::BeginGroup(XOR("Effects"), vec2_t(50, 100)); {
			...
			if (GUI::Form::BeginTab(XOR("P"), XOR("Players"))) 
			{			
				GUI::Group::BeginGroup(XOR("Player ESP"), vec2_t(50, 103));
				{
					...
					if (g_cfg[XOR("esp_enemies_box")].get<bool>())
					{
				...
				GUI::Group::BeginGroup(XOR("Player chams"), vec2_t(50, 100));
				{
					...
					std::vector<std::string> DesyncMaterial = {
						{ XOR("Flat") },
						{ XOR("Glow Armsrace") },
						{ XOR("Eso Glow") }
					};
					...
					if (g_cfg[XOR("esp_chams_enemies")].get<bool>()) {
						...
						GUI::Controls::Dropdown(XOR("Chams #Enemy"), Materials, XOR("esp_chams_enemies_material"));
					}
			...
			if (GUI::Form::BeginTab(XOR("M"), XOR("Misc")))
			{
				GUI::Group::BeginGroup(XOR("Movement"), vec2_t(50, 50));
				{
				...
				GUI::Group::BeginGroup(XOR("Viewmodel"), vec2_t(50, 50));
				{
				...
				GUI::Group::BeginGroup(XOR("General"), vec2_t(50, 100));
				{
					...
					GUI::Controls::Checkbox(XOR("Watermark"), XOR("misc_watermark"));
			...
			{
				GUI::Group::BeginGroup(XOR("Configs"), vec2_t(100, 60));
				{
					...
					GUI::Controls::Button(XOR("Save config#save"), [&]()
					{
			...
			if (GUI::Form::BeginTab(XOR("X"), XOR("Skins")))
			{
				GUI::Group::BeginGroup(XOR("General options"), vec2_t(50, 100)); 
				{
						...
						std::vector<std::string> Agents = {
							...
							{ XOR("Markus Delrow") },
							{ XOR("Michael Syfers") },
							{ XOR("B Squadron Officer") },
							{ XOR("Seal Team 6 Soldier") },
							{ XOR("Buckshot") },
							{ XOR("Lt. Commander Ricksaw") },
							{ XOR("3rd Commando Company") },
							{ XOR("'Two Times' McCoy") },
							{ XOR("'Blueberries' Buckshot") },
							{ XOR("'Two Times' McCoy (NSWC SEAL)") },
							{ XOR("Dragomir") },
							{ XOR("Rezan The Ready") },
							{ XOR("'The Doctor' Romanov") },
							{ XOR("Blackwolf") },
							{ XOR("Maximus") },
							{ XOR("Rezan the Redshirt") },
							{ XOR("Dragomir (Sabre Footsoldier)") },
							{ XOR("The Elite Mr. Muhlik") },
							{ XOR("Ground Rebel") },
							{ XOR("Osiris") },
							{ XOR("Prof. Shahmat") },
							{ XOR("Enforcer") },
							...
							{ XOR("Soldier") },
							{ XOR("Street Soldier") },
							{ XOR("Cmdr. Mae 'Dead Cold' Jamison") },
							{ XOR("'1st' Lieutenant Farlow") },
							{ XOR("John 'Van Healen' Kask") },
							{ XOR("Bio-Haz Specialist") },
							{ XOR("Sergeant Bombson") },
							{ XOR("Chem-Haz Specialist") },
							{ XOR("Sir Bloody Miami Darryl") },
							{ XOR("Sir Bloody Silent Darryl") },
							{ XOR("Sir Bloody Skullhead Darryl") },
							{ XOR("Sir Bloody Darryl Royale") },
							{ XOR("Sir Bloody Loudmouth Darryl") },
							{ XOR("Safecracker Voltzmann") },
							{ XOR("Little Kev") },
							{ XOR("Number K") },
							{ XOR("Getaway Sally") }
						};

						GUI::Controls::Checkbox(XOR("Agent Changer"), XOR("skins_agent_enable"));
						GUI::Controls::Dropdown(XOR("Agent Model"), Agents, XOR("skins_agent"));
