...
public:
	...
	void ShotRecord(LagComp::LagRecord_t* record, Color col, float time);
...
public:
	...
	int m_hitbox;
	bool m_stop;
	bool m_slow_motion_slowwalk;
	bool m_slow_motion_fakewalk;
...
public:
	...
	bool hitbox_intersection(Player* e, matrix3x4_t* matrix, int hitbox, const vec3_t& start, const vec3_t& end);
...
public:
	...
	bool hitchance(int& final_hitchance, ang_t& angle, Player* player, LagComp::LagRecord_t* record, int hitbox);
