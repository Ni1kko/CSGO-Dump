...
vec3_t math::CalcAngle(const vec3_t& src, const vec3_t& dst)
{
    vec3_t angles;
...
/*void math::vector_transform(const vec3_t& in1, const matrix3x4_t& in2, vec3_t& out)
{
...
/*void math::vector_i_transform(const vec3_t& in1, const matrix3x4_t& in2, vec3_t& out)
{
    float in1_t[3];
