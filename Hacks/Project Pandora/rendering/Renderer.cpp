...
void D3D::Initialise( IDirect3DDevice9 *device ) {
	...
	D3D9Fonts[ MAIN_FONT ] = D3D9DrawManager->add_font( XOR( "C:\\Windows\\Fonts\\segoeuib.ttf" ), 15.f,
		false, false, util::draw::GLYPH_RANGE_LATIN, util::draw::NO_ANTIALIASING);	
	...
	D3D9Fonts[ PIXEL_FONT ] = D3D9DrawManager->add_font(XOR( "C:\\Windows\\Fonts\\verdana.ttf" ), 9.f,
		false, false, util::draw::GLYPH_RANGE_LATIN, util::draw::NO_ANTIALIASING );

	//D3D9Fonts[INFO_FONT] = D3D9DrawManager->add_font(XOR("C:\\Windows\\Fonts\\segoeuib.ttf"), 17.f,
	//	false, false, util::draw::GLYPH_RANGE_LATIN, util::draw::NO_ANTIALIASING);
