...
void render::init()
{
	Verdana = Font(XOR("Verdana"), 12, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW | FONTFLAG_OUTLINE);
	grenade_esp = Font(XOR("Smallest Pixel-7"), 11, FW_MEDIUM, FONTFLAG_OUTLINE);
	esp = Font(XOR("Tahoma"), 11, FW_NORMAL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
