...
public:
	...
	struct Palette_t 
	{
		...
		struct MenuColors_t {
			static Color Form() { return Color(10, 10, 10, 235); }
			static Color Container() { return Color( 7, 7, 7, 225); }
			static Color Outlines( ) { return Color(118, 94, 255); }
			static Color ContainerHovered() { return Color( 13, 13, 13); }
		};
	};
