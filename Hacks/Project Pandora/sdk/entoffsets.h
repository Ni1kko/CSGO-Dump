...
public:
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_pCoordFrame;
	...
	XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_bGunGameImmunity;
...
#define INIT_XOREDNETVAR_SPECIFIC( member_var, offset ) \
		...
		INIT_XOREDNETVAR( m_flAnimTime, HASH( "DT_CSPlayer" ), HASH( "m_flAnimTime" ) );
		...
		INIT_XOREDNETVAR( m_bGunGameImmunity, HASH( "DT_CSPlayer" ), HASH( "m_bGunGameImmunity" ) );
		...
		INIT_XOREDNETVAR( m_hViewModel, HASH( "DT_BasePlayer" ), HASH( "m_hViewModel[0]" ) );
