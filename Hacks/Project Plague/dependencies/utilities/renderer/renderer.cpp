...
unsigned long render::fonts::main_font;
unsigned long render::fonts::esp_font;
unsigned long render::fonts::esp_font_small;
unsigned long render::fonts::arrow_font;

void render::initialize() {
	render::fonts::main_font = interfaces::surface->font_create();
	render::fonts::esp_font = interfaces::surface->font_create();
	render::fonts::esp_font_small = interfaces::surface->font_create();
	render::fonts::arrow_font = interfaces::surface->font_create();

	interfaces::surface->set_font_glyph(render::fonts::main_font, "Verdana Bold", 12, 700, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::esp_font, "Tahoma", 12, 700, 0, 0, font_flags::fontflag_dropshadow);
	interfaces::surface->set_font_glyph(render::fonts::esp_font_small, "Small Fonts", 8, 400, 0, 0, font_flags::fontflag_outline);
	interfaces::surface->set_font_glyph(render::fonts::arrow_font, "Verdana Bold", 20, 700, 0, 0, font_flags::fontflag_outline);
