...
int main(int argsCount, char **argv)
{
   stbtt_fontinfo font;
   unsigned char *bitmap;
   int w,h,i,j,c = (argsCount > 1 ? atoi(argv[1]) : 'a'), s = (argsCount > 2 ? atoi(argv[2]) : 20);

   fread(ttf_buffer, 1, 1<<25, fopen(argsCount > 3 ? argv[3] : "c:/windows/fonts/arialbd.ttf", "rb"));
