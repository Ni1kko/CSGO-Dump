...
struct Variables_t
{
	...
	C_ADD_VARIABLE(int, iPacketType, 0);
	C_ADD_VARIABLE(int, iBuildMethod, 0);
	C_ADD_VARIABLE(int, iTimingType, 0);
	C_ADD_VARIABLE(int, iLagAmount, 0);
	C_ADD_VARIABLE(int, iLagInterval, 0);
	C_ADD_VARIABLE(int, iLagKey, 0);
	C_ADD_VARIABLE(int, iLagType, 0);
	C_ADD_VARIABLE(int, iLagSize, 0);
