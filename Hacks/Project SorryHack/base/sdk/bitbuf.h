...
//#include "../../Resource/SteamWorks/steam/steamtypes.h"
...
#define BigLong( val )				DWordSwapC( val )
...
#define BITBUF_INLINE __forceinline
...
public:
	...
	//VIRTUAL_METHOD(void, StartWriting, 3, (void* pData, int nBytes, int iStartBit = 0, int nMaxBits = -1), (this, pData, nBytes, iStartBit, nMaxBits))
	...
	//VIRTUAL_METHOD(unsigned char*, GetBasePointer, 5, (void), (this))
	...
	//VIRTUAL_METHOD(const char*, GetDebugName, 7, (void), (this))
	const char* GetDebugName(); // 7
...
public:
	...
	// The current buffer.
	unsigned char* RESTRICT m_pData;
	uint32 m_nDataBytes;
	uint32 m_nDataBits;
	uint32 m_iCurBit;
	// Errors?
