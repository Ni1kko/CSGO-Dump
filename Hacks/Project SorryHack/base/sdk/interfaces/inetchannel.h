...
public:
	...
	void Shutdown(int unk, const char* reason)
	{
		return MEM::CallVFunc<void>(this, 38, unk, reason);
	}
...
public: 
	...
	virtual INetChannel* getNetworkChannel() const = 0;
	virtual const char* toString() const = 0;
	virtual std::size_t		GetSize() const = 0;*/
		VIRTUAL_METHOD(void, SetNetChannel, 1, (INetChannel* netchann), (this, netchann))
