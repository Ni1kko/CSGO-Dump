...
namespace HOOKS
{
    ...
    //typedef void(__fastcall* DrawSetClr)(SDK::ISurface* thisptr, void * edx, int r, int g, int b, int a);

	//typedef void(__thiscall* SetChokedFn)(SDK::NetChannel*, void*, void*);
	typedef bool(__thiscall* SvCheatsGetBoolFn)(void*);
	typedef float(__thiscall* GetViewmodelFOVFn)();
	typedef void(__thiscall* ExtraBoneProcess_t) (uintptr_t, SDK::studiohdr_t *, Vector *, Quaternion *, matrix3x4_t *, SDK::CBoneBitList &, SDK::CIKContext *);
	...
	extern ExtraBoneProcess_t Do_ExtraBonesProcessing;
	//extern SetChokedFn set_choked;
	...
	//extern DrawSetClr orig_drawsetcolor;
	...
	//extern VMT::VMTHookManager Do_ExtraBonesProcessing;
