...
namespace OFFSETS
{
	...
	//	INTERFACES::Engine->ExecuteClientCmd("clear");
		INTERFACES::cvar->ConsoleColorPrintf(CColor(255, 0, 0, 255), "[deathrow] \n");
		INTERFACES::cvar->ConsoleColorPrintf(CColor(0, 255, 0, 255), "[Offset parse start] \n");
		...
		m_flNextSecondaryAttack = UTILS::netvar_hook_manager.GetOffset(("DT_BaseCombatWeapon"), ("m_flNextSecondAttack"));
		m_flNextAttack = UTILS::netvar_hook_manager.GetOffset(("DT_BaseCombatCharacter"), ("m_flNextAttack"));
		m_bSpotted = UTILS::netvar_hook_manager.GetOffset(("DT_BaseEntity"), ("m_bSpotted"));
		...
		m_flFlashDuration = UTILS::netvar_hook_manager.GetOffset(("DT_CSPlayer"), ("m_flFlashDuration"));
		...
		INTERFACES::cvar->ConsoleColorPrintf(CColor(0, 255, 0, 255), "[Offset parse end] \n");
		//INTERFACES::cvar->ConsoleColorPrintf(CColor(0, 0, 255, 255), "[Good ok xd] \n");
		m_bDormant = 0xED;
		animstate = 0x3900;
