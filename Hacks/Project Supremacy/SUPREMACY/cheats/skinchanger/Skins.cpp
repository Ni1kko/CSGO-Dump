...
////						break;
////					case 2:
////						pWeapon->m_nFallbackPaintKit() = 441;
////						break;
////					case 3:
////						pWeapon->m_nFallbackPaintKit() = 448;
////						break;
////					case 4:
////						pWeapon->m_nFallbackPaintKit() = 556;
////						break;
////					case 5:
////						pWeapon->m_nFallbackPaintKit() = 688;
////						break;
////					default:
////						break;
////					}
...
////					if (worldmodel_handle2) worldmodel = (weapon_t*)g_csgo.m_entitylist()->GetClientEntityFromHandle(worldmodel_handle);
////					if (Model == 1) // Bayonet
////					{
...
////						pWeapon->m_iItemDefinitionIndex() = 500;
...
////						else if (Skin == 35)
////						{
////							pWeapon->m_nFallbackPaintKit() = 580; // Freehand
////						}
////					}
////					else if (Model == 10) // Bowie Knife
////					{
...
////						pWeapon->m_iItemDefinitionIndex() = 514;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////
////					}
////					else if (Model == 7) // Butterfly Knife
////					{
...
////						pWeapon->m_iItemDefinitionIndex() = 515;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////						}
////					}
////					else if (Model == 8) // Falchion Knife
////					{
...
////						pWeapon->m_iItemDefinitionIndex() = 512;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////						pWeapon->m_iItemDefinitionIndex() = 505;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////						pWeapon->m_iItemDefinitionIndex() = 506;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////						pWeapon->m_iItemDefinitionIndex() = 509;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////						pWeapon->m_iItemDefinitionIndex() = 507;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////						else if (Skin == 35)
////						{
////							pWeapon->m_nFallbackPaintKit() = 582; // Freehand
////						}
////
////					}
////					else if (Model == 5) // M9 Bayonet
////					{
...
////						pWeapon->m_iItemDefinitionIndex() = 508;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////						else if (Skin == 35)
////						{
////							pWeapon->m_nFallbackPaintKit() = 581; // Freehand
////						}
////
////					}
////					else if (Model == 9)
...
////						pWeapon->m_iItemDefinitionIndex() = 516;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
...
////						pWeapon->m_iItemDefinitionIndex() = 520;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
////						killIcons["knife_default_ct"] = "knife_push";
////						killIcons["knife_t"] = "knife_push";
...
////						}
////					}
////					else if (Model == 12) // Shadow Daggers
////					{
...
////						pWeapon->m_iItemDefinitionIndex() = 522;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
////						killIcons["knife_default_ct"] = "knife_push";
////						killIcons["knife_t"] = "knife_push";
...
////						pWeapon->m_iItemDefinitionIndex() = 519;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
////						killIcons["knife_default_ct"] = "knife_push";
////						killIcons["knife_t"] = "knife_push";
...
////						pWeapon->m_iItemDefinitionIndex() = 523;
////						pWeapon->m_iEntityQuality() = 3;
////						killIcons.clear();
////						killIcons["knife_default_ct"] = "knife_push";
////						killIcons["knife_t"] = "knife_push";
...
//					auto pCustomName1 = MakePtr(char*, pWeapon, 0x301C);
//					worldmodel_handle = pWeapon->m_hWeaponWorldModel();
//					if (worldmodel_handle) worldmodel = (weapon_t*)g_csgo.m_entitylist()->GetClientEntityFromHandleknife(worldmodel_handle);
//
//					if (Model == 0) // Bayonet
//					{
//						int iBayonet = g_csgo.m_modelinfo()->GetModelIndex("models/weapons/v_knife_bayonet.mdl");
