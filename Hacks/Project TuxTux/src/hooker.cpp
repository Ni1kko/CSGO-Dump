...
{
	uintptr_t func_address = PatternFinder::FindPatternInModule(XORSTR("client_panorama_client.so"),
																(unsigned char*) XORSTR("\x55\x48\x89\xE5\x41\x57\x41\x56\x41\x55\x41\x54\x49\x89\xD4\x53\x48\x81\xEC\x00\x00\x00\x00\x48\x85\xD2"),
																XORSTR("xxxxxxxxxxxxxxxxxxx????xxx"));
