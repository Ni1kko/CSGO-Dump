...
void Settings::LoadDefaultsOrSave(std::string path)
{
	...
	settings[XORSTR("ESP")][XORSTR("Info")][XORSTR("missed_shots")] = Settings::ESP::Info::missedShots;
	...
	settings[XORSTR("ESP")][XORSTR("GrenadePrediction")][XORSTR("enabled")] = Settings::ESP::GrenadePrediction::enabled;
	LoadColor(settings[XORSTR("ESP")][XORSTR("GrenadePrediction")][XORSTR("color")], Settings::ESP::GrenadePrediction::color);
...
void Settings::LoadConfig(std::string path)
{
	...
	Settings::Aimbot::weapons = {
			{ ItemDefinitionIndex::INVALID, { false, false, false, false, false, false, 700, Bone::BONE_HEAD, ButtonCode_t::MOUSE_MIDDLE, false, false, 1.0f,
													...
													false, false, false, false, false, false, false, false, 70.f, false, 10.0f, false, false, false, false } },
	};
	...
	GetVal(settings[XORSTR("ESP")][XORSTR("Info")][XORSTR("missed_shots")], &Settings::ESP::Info::missedShots);
	...
	GetVal(settings[XORSTR("ESP")][XORSTR("GrenadePrediction")][XORSTR("enabled")], &Settings::ESP::GrenadePrediction::enabled);
	GetVal(settings[XORSTR("ESP")][XORSTR("GrenadePrediction")][XORSTR("color")], &Settings::ESP::GrenadePrediction::color);
