...
void Misc::Chatspam() {
	...
	std::vector<std::string> chatspams = {
		"white.xyz | The best free legit cheat",
		"I use white.xyz - and is the better free legit cheat",
		"get owned by white.xyz",
	};
...
void Misc::Namespam() {
	...
	*(int*)((DWORD)&Name->m_fnChangeCallbacks + 0xC) = 0;
	...
	if (Name) {
		if (steal) Name->SetValue("white.xyz");		
		else Name->SetValue("white.xyz ");
		steal = !steal;
	}
}
...
void Misc::Clantag() {
	...
	if (int(g_GlobalVars->curtime * 2.9) != prevtime) {
		if (prevval != int(g_GlobalVars->curtime * 2.9) % 20) {
			prevval = int(g_GlobalVars->curtime * 2.9) % 20;
			switch (int(g_GlobalVars->curtime * 2.9) % 20)
			{
			case 20: { Utils::SetClantag("$ white.xyz $");  break; }
			case 19: { Utils::SetClantag("- w <");  break; }
			case 18: { Utils::SetClantag("- wh <");  break; }
			case 17: { Utils::SetClantag("- whi <");  break; }
			case 16: { Utils::SetClantag("- whit <");  break; }
			case 15: { Utils::SetClantag("- white <");  break; }
			case 14: { Utils::SetClantag("- white. <");  break; }
			case 13: { Utils::SetClantag("- white.x <");  break; }
			case 12: { Utils::SetClantag("- white.xy <");  break; }
			case 11: { Utils::SetClantag("+ white.xyz -");  break; }
			case 10: { Utils::SetClantag("- white.xyz +");  break; }
			case 9: { Utils::SetClantag("< white.xy -");  break; }
			case 8: { Utils::SetClantag("> white.x -");  break; }
			case 7: { Utils::SetClantag("> white. -");  break; }
			case 6: { Utils::SetClantag("> white -");  break; }
			case 5: { Utils::SetClantag("> whit -");  break; }
			case 4: { Utils::SetClantag("> whi -");  break; }
			case 3: { Utils::SetClantag("> wh -");  break; }
			case 2: { Utils::SetClantag("> w -");  break; }
			case 1: { Utils::SetClantag("-  -");  break; }
			case 0: { Utils::SetClantag("$ white.xyz $");  break; }
			default:;
			}
		}
	}
