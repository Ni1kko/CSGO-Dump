...
namespace ImGui
{
    ...
    IMGUI_API void          StyleColosClassic(ImGuiStyle* dst = NULL);

    // Styles
    IMGUI_API void          StyleColorsDark(ImGuiStyle* dst = NULL);
    IMGUI_API void          StyleColorsKillaura(ImGuiStyle* style);

	IMGUI_API void          StyleColorsKillaura(ImGuiStyle* dst = NULL);
	...
	IMGUI_API bool          TabButton(const char* label, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0));
...
enum ImGuiKeyBindFlags_
{
	ImGuiKeyBindFlags_None = 0,
	ImGuiKeyBindFlags_OnItem = 1 << 0,
	ImGuiKeyBindFlags_NoSettings = 1 << 1
};
