...
struct ImGuiContext
{
	...
	ImVector<ImGuiKeyBind*> keybinds;
...
namespace ImGui
{
    ...
    IMGUI_API bool          tab(const char* label, const char* icon, bool selected);
    IMGUI_API bool          subtab(const char* label, bool selected);
    IMGUI_API bool          category(const char* label, bool selected);
	...
	IMGUI_API void          RenderTextClippedOverlay(const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
	IMGUI_API void          RenderTextClippedOverlayEx(ImDrawList* draw_list, const ImVec2& pos_min, const ImVec2& pos_max, const char* text, const char* text_end, const ImVec2* text_size_if_known, const ImVec2& align = ImVec2(0, 0), const ImRect* clip_rect = NULL);
	...
	IMGUI_API bool          TabButtonEx(const char* label, const bool active = false, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
