	...
	struct style {
		...
		*/
		 ...
		 */
		 ...
		 // general
		std::array<fgui::color, 5> text = { fgui::color(181, 181, 181), fgui::color(215, 215, 100), fgui::color(198, 65, 255), fgui::color(245, 245, 245), fgui::color(137, 162, 204) };
		std::array<fgui::color, 2> cursor = { fgui::color(255, 255, 255), fgui::color(0, 0, 0) };
		std::array<fgui::color, 4> notifications = { fgui::color(85, 85, 85), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };

		// elements
		std::array<fgui::color, 4> button = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 5> checkbox = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255), fgui::color(145, 46, 191) };
		std::array<fgui::color, 4> colorlist = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 4> colorpicker = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 4> combobox = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 3> container = { fgui::color(65, 65, 65), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 4> keybinder = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 6> label = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(181, 181, 181), fgui::color(65, 158, 255), fgui::color(198, 65, 255) };
		std::array<fgui::color, 4> listbox = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 4> multibox = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 5> slider = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255), fgui::color(145, 46, 191) };
		std::array<fgui::color, 4> spinner = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 5> tabs = { fgui::color(65, 65, 65), fgui::color(15, 15, 15), fgui::color(40, 40, 40), fgui::color(35, 35, 35), fgui::color(60, 60, 60) };
		std::array<fgui::color, 4> textbox = { fgui::color(65, 65, 65), fgui::color(45, 45, 45), fgui::color(25, 25, 25), fgui::color(208, 128, 255) };
		std::array<fgui::color, 5> window = { fgui::color(25, 25, 25), fgui::color(40, 40, 40), fgui::color(255, 150, 250), fgui::color(208, 128, 255), fgui::color(145, 46, 191) };
	};
