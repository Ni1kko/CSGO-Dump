...
{
	//ThreadMemory::WriteMemory((void*)(adress), &ByteCodeOld[0], 7);
...
//			{
//				ADD_LOG("2-1\n");
//				//hThread = CreateThreadMemory(reinterpret_cast<void*>(SetupThread));
...
BOOL WINAPI DllMain( HINSTANCE hinstDLL , DWORD fdwReason , LPVOID lpReserved )
{
	...
	{	
		...
		MainSettings().UserName = "DEBUG_USER_2";
		MainSettings().key = "_KEY";
		MainSettings().id = "1779845395";
#endif
