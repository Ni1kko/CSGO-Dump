...
//	auto& pContext = cContext::GetInstance();
//
//	pContext.ApplyDetour<oReset>(oReset(VTable[0]),
//		reinterpret_cast<oReset>
//		(myReset),
//		&pReset);
//	ADD_LOG("Hook: Reset\n");
//
//	pContext.ApplyDetour<oPresent>(oPresent(VTable[1]),
//		reinterpret_cast<oPresent>
//		(myPresent),
//		&pPresent);
//
...
//	//зачем это?
	...
	g_pDevice = m_pDevice;
//
//	/*UNHOOK(Reset, VTable[0]);
//	UNHOOK(Present, VTable[1]);
//
//
//	*(PDWORD)&pReset = VTable[0];
//	*(PDWORD)&pPresent = VTable[1];*/
//
//
...
//	//hThreadVMT = ThreadMemory::CreateThreadMemory(reinterpret_cast<void*>(VMT_Patching));
//	//VMT_Patching(0);
}
