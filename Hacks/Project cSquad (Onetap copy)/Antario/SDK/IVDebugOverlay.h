...
template< typename Function > Function call_vfunc2(PVOID Base, DWORD Index)
{
...
public:
	...
	{
		call_vfunc2<void(__thiscall*)(void*, Vector&, Vector&, float&, int, int, int, int, float)>(this, 24)(this, mins, maxs, pillradius, r, g, b, a, duration);
	}
