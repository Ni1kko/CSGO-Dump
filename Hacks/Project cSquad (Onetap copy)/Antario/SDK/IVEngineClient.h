...
template< typename Function > Function call_vfunc444(PVOID Base, DWORD Index)
{
...
public:
	...
	void send_datagram()
	{
		...
		call_vfunc444<Fn>(this, 46)(this, NULL);
	}
};
struct SequenceData
{
	SequenceData::SequenceData(int instate, int outstate, int seqnr, float time)
	{
