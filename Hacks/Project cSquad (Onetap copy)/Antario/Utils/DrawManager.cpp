...
DrawManager::DrawManager()
{
	...
	g_Fonts.pFontIcons = nullptr;
	g_Fonts.pFontRando = nullptr;
	g_Fonts.pFontSmallestPixel7 = nullptr;
	g_Fonts.pFontInfo = nullptr;
	g_Fonts.pFontIcons13 = nullptr;
	this->pViewPort = { 0 };
}
...
void DrawManager::InitDeviceObjects(LPDIRECT3DDEVICE9 pDevice)
{
	...
	g_Fonts.pFontTahoma8 = std::make_unique<CD3DFont>(L"Tahoma", 8, 550);
	g_Fonts.pFontTahoma10 = std::make_unique<CD3DFont>(L"Tahoma", 7, 600);
	g_Fonts.pFontSmallestPixel7 = std::make_unique<CD3DFont>(L"Small Fonts", 6, FW_MEDIUM);
	g_Fonts.pFontRando = std::make_unique<CD3DFont>(L"Arial", 8, 0);
	g_Fonts.pFontIcons = std::make_unique<CD3DFont>(L"csgoicons", 9, 0);
	g_Fonts.pFontIcons13 = std::make_unique<CD3DFont>(L"csgoicons", 11, 0);
	g_Fonts.pFontInfo = std::make_unique<CD3DFont>(L"Verdana", 7, 700);
	g_Fonts.pFontName = std::make_unique<CD3DFont>(L"Verdana", 15, 650);
