...
namespace ImGui
{
	...
	IMGUI_API void          EndChild(bool shadow = false);
	...
	IMGUI_API bool			SelectableMeme(const char * label, bool selected, ImGuiSelectableFlags flags, const ImVec2 & size_arg);
