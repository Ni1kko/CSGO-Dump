...
namespace Global
{
	...
	extern bool bAARight;
	extern bool bAALeft;
	extern bool left;
	extern bool right;
	extern bool backwards;
	extern bool bAimbotting;
	extern bool bVisualAimbotting;
	extern float awall_dmg;
	//extern bool debug_lag;
	...
	extern int fakelag_choked;
	//extern float debug_pointscale;
	extern char *szLastFunction;
	extern HMODULE hmDll;

	extern bool bFakelag;
	extern bool bResolverStatus;
